...
#PRECIPITATION for each county was downloaded for 2019-2023. All stations in each county were combined for each day to calculated a daily county average rainfall value.
...
This report analyzes three sources of data: EPA Air Quality, Emissions & Generation Resource Integrated Database (eGRID), and National Oceanic and Atmospheric Administration
...
## Question 2: 
```{r Wrangle eGRID data, eval=TRUE, echo=FALSE}
...
```{r Wrangle Air Quality: PM2.5, eval=TRUE, echo=FALSE}
#Texas PM2.5 for each year. Formatted into yearly rather than daily data
TXPM2523 <- TXPM2523 %>% 
  mutate(Date=mdy(Date)) %>% 
  select("Date", "Daily.AQI.Value", "Local.Site.Name", 
...
```{r Data Import: Air Quality: Ozone, , eval=TRUE, echo=FALSE}
#Texas Ozone for each year. Formatted into yearly rather than daily data
TXOzone23 <- TXOzone23 %>% 
  mutate(Date=mdy(Date)) %>% 
  select("Date", "Daily.AQI.Value", "Local.Site.Name", 
...
```{r Wrangling: Emissions and AQI, , eval=TRUE, echo=FALSE}
...
```{r Q2 plots, eval=TRUE, echo=FALSE}
...
```{r Graph of rain Harris, echo=FALSE, fig.cap='Precipitation Harris County', message=FALSE, warning=FALSE, fig.height=3.75}
...
```{r Graph of rain Dallas, echo=FALSE, fig.cap='Precipitation Dallas County', message=FALSE, warning=FALSE,fig.height=3.75}
...
```{r Graph of ozone Harris, echo=FALSE, fig.cap='Ozone AQI Harris County', message=FALSE, warning=FALSE,fig.height=3.75}
...
```{r Graph of ozone Dallas, echo=FALSE, fig.cap='Ozone AQI Dallas County', message=FALSE, warning=FALSE,fig.height=3.75}
...
```{r Graph of PM Harris, echo=FALSE, fig.cap='PM2.5 AQI Harris County', message=FALSE, warning=FALSE,fig.height=3.75}
...
```{r Graph of PM Dallas, echo=FALSE, fig.cap='PM2.5 AQI Dallas County', message=FALSE, warning=FALSE,fig.height=3.75}
