...
```
\newpage
```{r Q2 plot: PM2.5 AQI over time, echo=FALSE, fig.cap="Average daily PM2.5 AQI in Harris County, Texas, 2019-2023"}
...
```
\newpage
```{r Q2 plot: Ozone AQI over time, echo=FALSE, fig.cap="Average daily ozone AQI in Harris County, Texas, 2019-2023"}
