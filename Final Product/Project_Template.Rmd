...
```{r Q1 Emissions vs Ozone, echo=FALSE, warning=FALSE, fig.cap = "Average Daily Ozone AQI Value vs. Annual CO2 Equivalent Emissions"}
...
```{r Q1 Emissions vs Ozone LR, warning=FALSE, include=FALSE}
...
```{r Q1 Emissions vs PM2.5, echo=FALSE, warning=FALSE, fig.cap = "Average Daily PM2.5 AQI Value vs. Annual CO2 Equivalent Emissions in Individual Counties"}
