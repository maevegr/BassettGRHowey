...
Emissions_O3 <- TXEmissions_Ozone %>% 
  ...
  ggtitle("Average Daily Ozone AQI Value vs. Annual CO2 Equivalent Emissions from Reporting Power Plants per County", subtitle = "Texas, 2018 - 2023")
...
Emissions_PM25<-TXEmissions_PM25 %>% 
  ...
  ggtitle("Average Daily PM2.5 AQI Value vs. Annual CO2 Equivalent Emissions from Reporting Power Plants per County", subtitle = "Texas, 2018 - 2023")
